// Inline SVG icon set (lucide-style 24×24 strokes, stroke=currentColor).
// Inlined so the strict CSP (`font-src 'self'`) can't break iconography the
// way it silently broke the old Material Symbols webfont in production.

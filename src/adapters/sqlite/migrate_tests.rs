...
async fn a_fully_migrated_database_is_adopted_and_only_the_unseen_files_run() {
    ...
    assert_eq!(outcomes(&ran, Outcome::Applied), vec!["015", "017", "018", "019", "020", "021", "022", "023", "024", "025", "026", "027"]);
...
async fn a_012_database_gains_the_missing_files_and_a_populated_index() {
    ...
    assert_eq!(outcomes(&ran, Outcome::Applied), vec!["013", "014", "015", "017", "018", "019", "020", "021", "022", "023", "024", "025", "026", "027"]);

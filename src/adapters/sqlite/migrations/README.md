...
| 027 | 027_cached_packages.sql | search-over-cache.md (port 24: what the proxy has served) | aed68ab685f6da77542314245529a8e4e5d8ca2c6d153d73021057a62f4c57b3 |
...
Ids from 018 on are order-independent: none reads or alters a table another of
them creates, and `025` ships before `018`-`024`; `026` and `027` read none of
them. The Postgres side of this directory is
`src/adapters/postgres/migrations/`, and it is empty.

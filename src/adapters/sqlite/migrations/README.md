...
| 026 | 026_token_scopes.sql | scopes.md (the scope a token carries, the conservative `delete := write` backfill) | 359b691e29795d97e768c3c469d5e93b777b07673ebf380631aa8721199e39e9 |
...
of them creates, and `025` ships before `018`-`024`. `026` only touches
`api_tokens` and `user_permissions`, which `003` and `010` created. The
Postgres side of this directory is `src/adapters/postgres/migrations/`, and it is empty.
